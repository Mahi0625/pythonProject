...
def create_excel_file(categories):
    workbook = xlsxwriter.Workbook('/home/ubuntu/pythonProject/BigBasket/Bigbasket_products.xlsx')
...
def create_database():
    conn_products = sqlite3.connect('/home/ubuntu/pythonProject/BigBasket/Bigbasket_products_database.db')
    ...
    c_products.execute('''CREATE TABLE IF NOT EXISTS products (
        ...
        category TEXT,
        quantity TEXT,
        timestamp TEXT  -- Change the data type to TEXT
    )''')
    conn_products.commit()
    conn_products.close()

    conn_history = sqlite3.connect('/home/ubuntu/pythonProject/BigBasket/Bigbasket_price_history.db')
...
def main_function(url, category_name, existing_df):
    ...
    inserted_products = load_inserted_products('home/ubuntu/pythonProject/BigBasket/Bigbasket_inserted_products.txt')
    ...
    update_inserted_products('home/ubuntu/pythonProject/BigBasket/Bigbasket_inserted_products.txt', inserted_products)
...
def run_scraping_and_notification():
    ...
    if not os.path.isfile('/home/ubuntu/pythonProject/BigBasket/Bigbasket_products.xlsx'):
    ...
    for category in categories:
        ...
        conn = sqlite3.connect('/home/ubuntu/pythonProject/BigBasket/Bigbasket_products_database.db')
    ...
    with pd.ExcelWriter('/home/ubuntu/pythonProject/BigBasket/Bigbasket_products.xlsx', engine='xlsxwriter') as writer:
        for category in categories:
            category_name = category[1]
    ...
    recipients = ['rprithvi786@gmail.com','naveen.jeena@vegease.in','harsh.goyal@vegease.in','amit.khanna@egreens.com','arpit@egreens.com','mahimatripathi0625@gmail.com']   # Add the other email here
